...
from models.GPT2_G import GPT2_G
...
class GPT2GANInstructor(BasicInstructor):
    def __init__(self, opt):
        super(GPT2GANInstructor, self).__init__(opt)

        # generator, discriminator
        self.gen = GPT2_G(opt.gpt_path, max_seq_len=cfg.max_seq_len,
                          temperature=cfg.temperature, num_samples=opt.samples_num,
                          gpu=cfg.CUDA)
